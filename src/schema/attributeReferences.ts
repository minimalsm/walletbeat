									...
									return [
										{
											urls: Array.isArray(entity.leaks.multiAddress.ref)
												...
												: [
														{
															url:
																typeof entity.leaks.multiAddress.ref === 'string'
						...
						refs.push({
							urls: Array.isArray(txSubmission.l1.selfBroadcastViaDirectGossip.ref)
								...
								: [
										{
											url:
												typeof txSubmission.l1.selfBroadcastViaDirectGossip.ref === 'string'
						...
						refs.push({
							urls: Array.isArray(txSubmission.l2.opStack.ref)
								...
								: [
										{
											url:
												typeof txSubmission.l2.opStack.ref === 'string'
							...
							urls: Array.isArray(features.monetization.ref)
								? features.monetization.ref.map((ref: any) => ({
										...
										label:
											typeof ref === 'string'
												? 'Funding source'
												: ref.explanation || 'Funding source',
									}))
								: [
										{
											url:
												typeof features.monetization.ref === 'string'
